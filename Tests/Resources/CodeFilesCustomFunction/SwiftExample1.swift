...
class SwiftExample1 {
  func exampleFunction1() {
    ...
    let testString1 = BCLocalizedString("test.multiline_comment", comment: "test comment 1")
    let testString2 = BCLocalizedString("test.multiline_comment", comment: "test comment 2")
